    ...
    function initialize(){
        ...
        var TitleScene = Class.create( Scene, {
            ...
            onEnter: function() {
                ...
                this.title.font = "30px 'Arial Black'"; 
                this.title.moveTo( 0, 0 );


                this.gamestart  = new Label( "Tap to Start" );
                this.gamestart.font = "24px 'Arial Black'"; 
                this.gamestart.moveTo( 0, 50 );
        ...
        var Field    = Class.create( Group, {
            ...
            onUpdate: function() {
                //if ( this.needToUpdateArrows ) {
                    ...
                    //for ( var i = 0; i < length; i++ ) {
                        //this.drawnArrows[i].newArrow.visible = true;
                        //this.drawnArrows[i].lastArrow.visible = true;
                    //}
                    //this.needToUpdateArrows = false;
                //}
            },
            ...
            onTouchStart: function(e) {
                ...
                var p = this.fields[pos.x][pos.y];
                var connectedPanel = new ConnectedPanel( p, undefined, undefined, pos );
                this.connectedPanelsManager = new ConnectedPanelManager();
                this.connectedPanelsManager.push( connectedPanel );
                this.addChild( connectedPanel );
            ...
            onTouchEnd: function(e) {
                ...
                //for ( var i = 0; i < drawnArrowLength; i++ ){
                    //this.removeChild(this.drawnArrows[i].newArrow);
                    //this.removeChild(this.drawnArrows[i].lastArrow);
                //}
            ...
            connectPanels: function( pos, panel ) {
                this.drawArrows( pos, panel );
                if( panel.setChained() ){
                    this.chainedNum++
                    panel.onTouch();
                    this.setLastTargetPos( pos );
            ...
            drawArrows: function( pos, panel ) {
                var dirs = this.getDirection( pos );
                var newArrow  = this.makeArrow( pos,                dirs.newPanel );
                var lastArrow = this.makeArrow( this.lastTargetPos, dirs.lastPanel );
                var connectedPanel = new connectedPanel( panel, oldArrow, newArrow, pos );
                this.connectedPanelsManager.push( connectedPanel );
                this.addChild( connectedPanel );
            },

            makeArrow: function( pos, dir ) {
                //var drawnArrowLength    = this.drawnArrows.length;
                //for ( var i = 0; i < drawnArrowLength; i++ ){
                    //var a = this.drawnArrows[i];
                    //if ( pos.x === a.pos.x && pos.y === a.pos.y && dir === a.dir ) { return; }
                //}
        ...
        var ConnectedPanelManager = Class.create( {
            initialize: function() {
                this.connectedPanels = [];
                this.connectedNum    = 0;
            },
            push: function( connectedPanel) {
                this.connectedPanels.push( connectedPanel );
                this.connectedNum++;
            },
        } );

        var ConnectedPanel = Class.create( Group, {
            initialize: function( panel, oldArrow, newArrow, pos ) {
                Group.apply ( this, arguments );
                this.panel    = panel;
                this.oldArrow = oldArrow;
                this.newArrow = newArrow;
                this.pos      = pos;
                this.addChild( this.panel );
                this.addChild( this.oldArrow );
